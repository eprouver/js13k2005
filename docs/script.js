...
const css = `#start .center,#start-cat,#timer,canvas{position:absolute}#angler,body{display:flex}.cell,.holder{transition:1s}*,.cell *{pointer-events:none}#range,.om,.reflect .c1,.screen,body{overflow:hidden}#mho,#start .center,.holder{text-align:center}#mho,#timer{font-weight:700}#canvas-2,.cho{z-index:2}*{transform-style:preserve-3d;perspective:5000px;transform-origin:50% 50%}body{--boardRot:50deg;--bopacity:0.25;--baseTransition:0.2s ease all;--ease1:linear(
    0,
    -0.004 4.9%,
    -0.02 9.4%,
    -0.124 26.4%,
